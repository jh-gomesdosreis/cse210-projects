using System;
// as a stretch, I tried to log for how many times activities were completed and make sure prompts were not repeated when playing the activities.
        ...
        while (running)
        {
            ...
            {   
                ...
                case 4:
                    ...
                    Console.WriteLine($"Breathing Activity: {breatheCount} time(s)");
                    Console.WriteLine($"Reflecting Activity: {reflectCount} time(s)");
                    Console.WriteLine($"Listing Activity: {listCount} time(s)");
                    Console.WriteLine();
